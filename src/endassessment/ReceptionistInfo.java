 ...
 * @author USER
 */
public class ReceptionistInfo extends javax.swing.JPanel {
    ...
    public void refresh() {
        String sql = "select id,username, fullname, dob, gender, type, status from users where type='receptionist'";
        try {
            pre = con.prepareStatement(sql);
            res = pre.executeQuery();
            receptionistsTable.setModel(DbUtils.resultSetToTableModel(res));
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Receptionist List");
            ...
            .addGroup(jPanel4Layout.createSequentialGroup()
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                        .addComponent(DeleteUserBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 43, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jScrollPane2.setViewportView(receptionistsTable);
    ...
    private void UpdateUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateUserBtnActionPerformed
        ...
        if (txtFname.getText().equals("")) {
            ...
            t = receptionistsTable.getModel().getValueAt(row, 0).toString();
            selectedUser = t;
            ...
            try {
                pre = con.prepareStatement(sql);
                pre.execute();
                JOptionPane.showMessageDialog(null, "Receptionist Updated Successfully", "Success", 1);
                clear();
                refresh();
            } catch (Exception e) {
    ...
    private void AddUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddUserBtnActionPerformed
        ...
        if (txtFname.getText().equals("")) {
            ...
            String sql = "insert into users (username,fullname,dob,phone,password,gender,type) values ('" +txtFname.getText().toLowerCase()+ "','" + fullname  + "',"
                    ...
                    + " '" + txtGender.getText() + "', '"+type+"')";

            try {
                pre = con.prepareStatement(sql);
                pre.execute();
                JOptionPane.showMessageDialog(null, "Receptionist Added Successfully", "Success", 1);
                clear();
                refresh();
            } catch (Exception e) {
    ...
    private void DeleteUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteUserBtnActionPerformed
        ...
        try {
            pre = con.prepareStatement(sql);
            pre.execute();
            JOptionPane.showMessageDialog(null, "Receptionist Deleted", "Success", 1);
            refresh();
            clear();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage(), "Error", 2);
    ...
    private void AppUserBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AppUserBtnActionPerformed
        ...
        try {
            pre = con.prepareStatement(sql);
            pre.execute();
            JOptionPane.showMessageDialog(null, "Receptionist Approved Successfully", "Success", 1);
            refresh();
        } catch (Exception e) {
            JOptionPane.showMessageDialog(null, e.getMessage(), "Error", 2);
        }
